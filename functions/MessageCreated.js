module.exports = {
    ...
    html: function (data) {
        ...
        <input class="input-field" id="functionName21" name="functionName21">
        <a onclick="openVar('functionName21')" class="var-btn">INSERT VARIABLE</a><br><br>
        `;
    },
    ...
    execute: function (DBA, info, message) {
        DBA.callFunction(DBA.var(info.functionName21.value), message);
    },
};
