module.exports = {
    ...
    SetEventCategory: "messageDelete",
    ...
    execute: function (DBA, mods) {
        DBA.bot.on("messageDelete", message => {
            ...
            DBA.saveVariable("deletedMessage.content", message.content);
            DBA.saveVariable("deletedMessage.id", message.id);
