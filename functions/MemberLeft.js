module.exports = {
    ...
    EventCategory: "guildMemberRemove",
    ...
    execute: function (DBA, variables, member) {
        DBA.saveVariable(`${variables.memberLeave.value}.id`, member.user.id);
        DBA.saveVariable(`${variables.memberLeave.value}.username`, member.user.username);
        DBA.saveVariable(`${variables.memberLeave.value}.tag`, member.user.tag);
        DBA.saveVariable(`${variables.memberLeave.value}.avatar`, member.user.avatarURL({ dynamic: true }));
        ...
        DBA.callFunction(DBA.var(variables.functionName11.value), member);
    },
};
