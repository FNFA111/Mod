module.exports = {
    ...
    EventCategory: "messageReactionAdd",
    ...
    execute: function (DBA, variables, reaction, user) {
        DBA.saveVariable(`${variables.reactionAdd.value}.name`, reaction.emoji.name);
        DBA.saveVariable(`${variables.reactionAdd.value}.url`, reaction.emoji.url);
        DBA.saveVariable(`${variables.reactionAdd.value}.messageContent`, reaction.message.content);
        DBA.saveVariable(`${variables.reactionAdd.value}.messageId`, reaction.message.id);
        ...
        DBA.callFunction(DBA.var(variables.functionName16.value), reaction.message);
    },
};
